...
;create database
(query-exec db "create table Bedroom_devices (device_name varchar(20),device_adress blob, onlinestatus integer, offlinecounter integer)")
(query-exec db "create table Bathroom_devices (device_name varchar(20),device_adress blob, onlinestatus integer, offlinecounter integer)")
(query-exec db "create table Livingroom_devices (device_name varchar(20),device_adress blob, onlinestatus integer, offlinecounter integer)")
